<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AddNewProducts.aspx.cs" Inherits="ShoppingAdder.Admin.AddNewProducts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center" cellspacing="1" style="width:100px;" align="left">
        <tr>
        ...
        <tr>
            ...
            <td style="width:50%;" align="left">
                <asp:FileUpload ID="uploadProductPhoto" runat="server"></asp:FileUpload>
            </td>
        </tr>
        <tr>
            <td style="width:50%; padding-left:100px;" align="left">
